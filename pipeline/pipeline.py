...
def run_pipeline():
    ...
    plot_correlation(train_df.select_dtypes(include=[np.number]).drop(columns=['label'], errors='ignore'))
...
def plot_precision_recall():
    ...
    plt.xticks(x, ['LogReg','RF','XGB'])
    plt.legend()
    plt.title("Precision vs Recall")
    plt.savefig("artifacts/precision_recall.png")
    plt.close()
...
# ================================
# 6. Case Comparison (your inputs)
# ================================
def plot_case_comparison():
    cases = ['Failure','Healthy','Medium']
    probs = [0.7889, 0.0001, 0.3417]

    plt.figure()
    plt.bar(cases, probs)
    plt.title("Failure Probability Comparison")
    plt.savefig("artifacts/case_comparison.png")
    plt.close()

# ================================
# 7. RUL vs Probability
# ================================
...
def plot_model_f1():
    ...
    plt.savefig("artifacts/model_f1.png")
    plt.close()
...
def plot_confidence():
    ...
    counts = [1,1,1]  # based on your 3 cases

    plt.figure()
    plt.bar(levels, counts)
    plt.title("Confidence Distribution")
    plt.savefig("artifacts/confidence.png")
    plt.close()
